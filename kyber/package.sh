...
unifdef -k -m -DKYBER_K=2 -DKYBER_ETA=2 -DKYBER_POLYCOMPRESSEDBYTES=96 -DKYBER_90S ${BUILD_CRYPTO_KEM}/kyber512-90s/*/*.{c,h,S}
unifdef -k -m -DKYBER_K=2 -DKYBER_ETA=2 -DKYBER_POLYCOMPRESSEDBYTES=96 -UKYBER_90S ${BUILD_CRYPTO_KEM}/kyber512/*/*.{c,h,S}

unifdef -k -m -DKYBER_K=3 -DKYBER_ETA=2 -DKYBER_POLYCOMPRESSEDBYTES=128 -DKYBER_90S ${BUILD_CRYPTO_KEM}/kyber768-90s/*/*.{c,h,S}
unifdef -k -m -DKYBER_K=3 -DKYBER_ETA=2 -DKYBER_POLYCOMPRESSEDBYTES=128 -UKYBER_90S ${BUILD_CRYPTO_KEM}/kyber768/*/*.{c,h,S}

unifdef -k -m -DKYBER_K=4 -DKYBER_ETA=2 -DKYBER_POLYCOMPRESSEDBYTES=160 -DKYBER_90S ${BUILD_CRYPTO_KEM}/kyber1024-90s/*/*.{c,h,S}
unifdef -k -m -DKYBER_K=4 -DKYBER_ETA=2 -DKYBER_POLYCOMPRESSEDBYTES=160 -UKYBER_90S ${BUILD_CRYPTO_KEM}/kyber1024/*/*.{c,h,S}
endtask
