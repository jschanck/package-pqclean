--- upstream/crypto_sign/falcon1024dyn/avx2/api.c
+++ upstream-patched/crypto_sign/falcon1024dyn/avx2/api.c
@@ -1,19 +1,45 @@
 /*
...
-	set_fpu_cw(savcw);
 	...
 	sk[0] = 0x50 + 10;
 	u = 1;
-	v = falcon1024dyn_avx2_trim_i8_encode(
-		sk + u, CRYPTO_SECRETKEYBYTES - u, f, 10,
-		falcon1024dyn_avx2_max_fg_bits[10]);
...
@@ -76,8 +99,9 @@
 	 ...
 	 */
 	pk[0] = 0x00 + 10;
-	v = falcon1024dyn_avx2_modq_encode(
...
@@ -114,25 +147,22 @@
 	...
 	u = 1;
-	v = falcon1024dyn_avx2_trim_i8_decode(
-		f, 10,
-		falcon1024dyn_avx2_max_fg_bits[10],
...
-	if (!falcon1024dyn_avx2_complete_private(
-		G, f, g, F, 10, tmp.b))
...
-		&sc, r.hm, 10);
+	falcon1024dyn_ref_hash_to_point_vartime(&sc, r.hm, 10);
...
-	 */
-	esig[0] = 0x20 + 10;
-	sig_len = falcon1024dyn_avx2_comp_encode(
...
-	if (falcon1024dyn_avx2_modq_decode(
-		h, 10, pk + 1, CRYPTO_PUBLICKEYBYTES - 1)
-		!= CRYPTO_PUBLICKEYBYTES - 1)
-	{
-		return -1;
-	}
-	falcon1024dyn_avx2_to_ntt_monty(h, 10);
-
-	/*
...
-	if (falcon1024dyn_avx2_comp_decode(
...
+	inner_shake256_ctx_release(&sc);
 	 ...
 	 * Verify signature.
 	 */
-	if (!falcon1024dyn_avx2_verify_raw(
-		hm, sig, h, 10, tmp.b))
-	{
