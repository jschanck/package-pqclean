--- upstream/crypto_sign/falcon1024dyn/avx2/inner.h
+++ upstream-patched/crypto_sign/falcon1024dyn/avx2/inner.h
@@ -73,166 +73,12 @@
...
+int falcon1024dyn_avx2_count_nttzero(const int16_t *sig, unsigned logn, uint8_t *tmp);
