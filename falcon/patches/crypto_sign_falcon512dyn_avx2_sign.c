--- upstream/crypto_sign/falcon512dyn/avx2/sign.c
+++ upstream-patched/crypto_sign/falcon512dyn/avx2/sign.c
@@ -1024,7 +1024,7 @@
...
@@ -1175,8 +1175,8 @@
 falcon512dyn_avx2_sampler(void *ctx, fpr mu, fpr isigma)
 {
 	sampler_context *spc;
-	int s;
-	fpr r, dss, ccs;
...
@@ -1216,7 +1213,7 @@
 		 *    centered on 0.
 		 */
 		z0 = falcon512dyn_avx2_gaussian0_sampler(&spc->p);
...
-			? fpr_sigma_min_10
-			: fpr_sigma_min_9;
-		falcon512dyn_avx2_prng_init(&spc.p, rng);
-		samp = falcon512dyn_avx2_sampler;
+		if (logn == 10) {
