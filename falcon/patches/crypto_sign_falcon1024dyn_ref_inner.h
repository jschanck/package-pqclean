--- upstream/crypto_sign/falcon1024dyn/ref/inner.h
+++ upstream-patched/crypto_sign/falcon1024dyn/ref/inner.h
@@ -73,127 +73,12 @@
...
-
-#define inner_shake256_init      falcon1024dyn_ref_i_shake256_init
-#define inner_shake256_inject    falcon1024dyn_ref_i_shake256_inject
-#define inner_shake256_flip      falcon1024dyn_ref_i_shake256_flip
-#define inner_shake256_extract   falcon1024dyn_ref_i_shake256_extract
-
-void falcon1024dyn_ref_i_shake256_init(
-	inner_shake256_context *sc);
-void falcon1024dyn_ref_i_shake256_inject(
-	inner_shake256_context *sc, const uint8_t *in, size_t len);
-void falcon1024dyn_ref_i_shake256_flip(
-	inner_shake256_context *sc);
-void falcon1024dyn_ref_i_shake256_extract(
...
@@ -450,7 +313,7 @@
  ...
  */
-int falcon1024dyn_ref_count_nttzero(int16_t *sig, unsigned logn, uint8_t *tmp);
+int falcon1024dyn_ref_count_nttzero(const int16_t *sig, unsigned logn, uint8_t *tmp);
