--- upstream/Optimized_Implementation/hqc-rmrs-128/src/reed_solomon.c
+++ upstream-patched/Optimized_Implementation/hqc-rmrs-128/src/reed_solomon.c
@@ -7,6 +7,7 @@
 #include "gf.h"
...
-	uint16_t tmp[PARAM_G + 1] = {0}; // +1 to fit with 256-bit register
-	uint16_t PARAM_RS_POLY [] = {RS_POLY_COEFS, 0}; // add 0 to fit with 256-bit register
-
