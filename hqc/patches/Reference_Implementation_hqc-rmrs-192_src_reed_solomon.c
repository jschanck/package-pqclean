--- hqc-2020-05-29/Reference_Implementation/hqc-rmrs-192/src/reed_solomon.c
+++ hqc-2020-05-29-patched/Reference_Implementation/hqc-rmrs-192/src/reed_solomon.c
@@ -15,67 +15,15 @@
 #include <stdio.h>
 #endif
